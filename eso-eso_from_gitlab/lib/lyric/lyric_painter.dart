...
class LyricPainter extends CustomPainter with ChangeNotifier {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    lyricTextPaints[currentLyricIndex]
      ...
      ..layout(maxWidth: lyricMaxWidth ?? 0);
    double currentLyricY = _offset +
        size.height / 2 -
    ...
    for (int lyricIndex = 0; lyricIndex < lyrics.length; lyricIndex++) {
      ...
      currentLyricTextPaint.layout(maxWidth: lyricMaxWidth ?? 0);
      double currentLyricHeight = currentLyricTextPaint.height;
      //仅绘制在屏幕内的歌词
      ...
      if (subLyrics != null) {
        ...
        remarkLyrics.forEach((remarkLyric) {
          ...
          currentSubPaint..layout(maxWidth: lyricMaxWidth ?? 0);
          //当前歌词结束后调整下次开始绘制歌词的y坐标
